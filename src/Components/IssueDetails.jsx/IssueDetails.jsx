...
const IssueDetails = () => {
  ...
  // Initialize hasUpvoted from issue data
  useEffect(() => {
    if (issue?.upvotedBy && userId) {
      setHasUpvoted(issue.upvotedBy.includes(userId));
    }
      ...
      if (data.success) {
        ...
        setIssue(prev => ({
          ...
          upvotedBy: data.hasUpvoted 
            ...
            : (prev.upvotedBy || []).filter(id => id !== userId)
        }));
      } else {
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="p-6 md:p-8">
            ...
            {/* Upvote Button - Larger and more prominent */}
            <div className="mb-8">
              <button
