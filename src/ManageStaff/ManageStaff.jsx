...
const ManageStaff = () => {
  ...
  const fetchAllUsers = useCallback(async () => {
    try {
      ...
      if (response.data.success && Array.isArray(response.data.users)) {
        ...
        console.log('✅ Got users:', usersData.length);
          ...
          <div className="p-6">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                {selectedUser.isPremium && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-yellow-600 font-medium">Premium User</span>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-3 gap-2 mb-3">
                {[
                  ...
                  return (
                    ...
                    >
                      <Icon className={`w-6 h-6 mb-2 text-${role.color}-500`} />
                      ...
                      {isDisabled && (
                        <span className="text-xs text-gray-500 mt-1">(Can't change your own admin role)</span>
                      )}
                    </button>
                  );
                })}
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                ...
                <ul className="text-xs text-blue-700 space-y-1">
                  <li>• <strong>User:</strong> Can report issues and use basic features</li>
                  <li>• <strong>Staff:</strong> Can be assigned issues and update progress</li>
            ...
            {(selectedUser.role === 'admin' || newRole === 'admin') && !isEditingSelf && (
              <div className="mb-6 bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-sm font-medium text-yellow-800">⚠️ Admin Role Change</p>
                    <p className="text-xs text-yellow-700 mt-1">
                      Changing admin roles affects system access privileges. Ensure this change is intended.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button
                ...
                className="px-4 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center gap-2"
              >
                {updating ? (
                  <>
  ...
  return (
    <div className="p-3 sm:p-4 md:p-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <div>
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 flex items-center gap-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl flex items-center justify-center">
          ...
          <button
            ...
            className="px-4 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all flex items-center gap-2 shadow-sm hover:shadow"
          >
          ...
          <div className="bg-white p-4 rounded-xl shadow border border-gray-200">
            <div className="flex items-center justify-between">
              ...
              <div className="w-10 h-10 bg-red-100 rounded-lg flex items-center justify-center">
                <FaCrown className="w-5 h-5 text-red-600" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-xl shadow border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-yellow-600 mt-1">{stats.premium}</p>
              </div>
      ...
      <div className="bg-white p-4 sm:p-6 rounded-xl shadow border border-gray-200 mb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div>
            <div className="relative">
              ...
              <select
                ...
                className="pl-10 pr-4 py-3 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none"
              >
          ...
          <div className="flex gap-3">
            <button
              ...
              className="px-4 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 flex items-center gap-2 flex-1 justify-center"
            >
        ...
        <div className="mt-4 text-sm text-gray-500 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
          <div>
                  ...
                  <tr key={user._id || user.email} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-3">
                        {user.photoURL ? (
                          ...
                          <div className="h-10 w-10 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center border-2 border-white shadow-sm">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-500 mt-1">
                            {user.provider ? `Signed up via ${user.provider}` : 'Email signup'}
                          </div>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex flex-col gap-2">
                        <span className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full w-fit ${
                          user.role === 'admin' 
                            ? 'bg-red-100 text-red-800 border border-red-200' 
                            : user.role === 'staff'
                            ? 'bg-purple-100 text-purple-800 border border-purple-200'
          ...
          <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div className="text-sm text-gray-600">
                ...
                <span className="mx-2">Sorted by: Registration Date</span>
              </div>
      ...
      <div className="mt-6 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-5">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-medium text-blue-900 mb-2">User Role Management Guide</h3>
            <ul className="text-sm text-blue-800 space-y-1">
              ...
              <li>• Role changes take effect immediately after update</li>
            </ul>
          </div>
        </div>
      </div>
